...
package com.avsoft.mythological.hanumanchalisa;
...
public class CurlActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mCurlView.setBackgroundColor(0xFF0000);
	...
	private class PageProvider implements CurlView.PageProvider {
		...
		// Bitmap resources.
		private int[] mBitmapIds = { R.drawable.frnt,R.drawable.h1, R.drawable.h2,
				R.drawable.h3, R.drawable.h4 ,R.drawable.h5, R.drawable.h6,
				R.drawable.h7, R.drawable.h8,R.drawable.h9, R.drawable.h10,
				R.drawable.h11, R.drawable.h12 , R.drawable.mylogo };
